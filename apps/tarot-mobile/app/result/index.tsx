...
const styles = StyleSheet.create({
  ...
  cardReveal:     { backgroundColor: Colors.graphiteBase, borderRadius: Radius.cards, padding: Spacing.s24, borderWidth: 1, borderColor: "#343434", shadowColor: Colors.taroEssence, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8 },
  ...
  divider:        { height: 1, backgroundColor: Colors.carbonBorder, marginVertical: 16 },
  headline:       { color: Colors.whiteout, fontSize: 24, marginTop: 16, marginBottom: 12, fontWeight: "700", lineHeight: 34 },
  summary:        { color: Colors.silverHighlight, fontSize: 16, marginBottom: 12, lineHeight: 24 },
  detail:         { color: Colors.midGrayText, fontSize: 16, lineHeight: 24, opacity: 0.9 },
