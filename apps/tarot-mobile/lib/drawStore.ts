...
export interface DrawnCard {
  ...
  detail: string;
  slot?: string | null;
  /** 카드 아키타입과 사용자 상황을 연결하는 몰입형 미니 내러티브 */
  storyText?: string;
}
...
export const MOCK_CARDS: DrawnCard[] = [
  {
    ...
    detail: "시장은 지금 예측 불가능한 국면에 들어서고 있습니다. 바보 카드는 무한한 가능성을 상징하지만, 동시에 주의가 필요함을 경고합니다. 기존의 분석 틀을 내려놓고 새로운 시각으로 접근하는 것이 유효할 수 있습니다.",
    storyText: getCardStory("the-fool", false),
  },
  {
    id: "the-tower",
    name: "The Tower",
    ...
    storyText: getCardStory("the-tower", true),
  },
  {
    id: "the-star",
    name: "The Star",
    ...
    storyText: getCardStory("the-star", false),
  },
];
