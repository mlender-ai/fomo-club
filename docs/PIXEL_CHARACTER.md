...
> ⚠️ **[폐기 — 히스토리 보존]** 마스코트 "포모" 캐릭터는 **현재 정체성이 아니다.** 현재 정본: `docs/PRODUCT_VISION.md` (**주식시장의 틴더 v5 — 두 표면·한 엔진**). 화면의 중심은 종목 카드와 발견 경험이며, 마스코트 부활은 금지. 새 작업·에이전트는 SSOT(PRODUCT_VISION)를 따른다.
