...
|---|---|---|---|---|---|---|
| 전체 | 100 | 52 | 52% | 13 | 13% | 35 (35%) |
| KR | 50 | 22 | 44% | 5 | 10% | 23 (46%) |
| US | 50 | 30 | 60% | 8 | 16% | 12 (24%) |
...
| CYCLICAL COMMODITY | · | · | **20** | · | · | · | · | 9 | 11 |
| HYPERGROWTH UNPROFITABLE | · | · | · | **1** | · | · | · | 2 | · |
| MATURE INCOME | · | · | · | · | · | · | · | · | 8 |
| PHARMA STABLE | · | · | · | · | · | **9** | · | · | 2 |
...
|---|---|---|---|---|---|---|
| LG화학 | KR | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | 화학 | loss |
| 롯데케미칼 | KR | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | 화학 | loss |
| POSCO홀딩스 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 철강 | no_rule_matched |
| 현대제철 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 철강 | no_rule_matched |
| S-Oil | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 석유와가스 | no_rule_matched |
| SK이노베이션 | KR | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | 석유와가스 | loss |
| 삼성중공업 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 조선 | no_rule_matched |
| 팬오션 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 해운사 | no_rule_matched |
| 현대차 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 자동차 | no_rule_matched |
| 기아 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 자동차 | no_rule_matched |
| 현대모비스 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 자동차부품 | no_rule_matched |
| OCI홀딩스 | KR | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | 화학 | loss |
| 풍산 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 비철금속 | no_rule_matched |
| 세아베스틸지주 | KR | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | 철강 | no_rule_matched |
...
| Cleveland-Cliffs | US | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Metal Mining | loss |
| Dow | US | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Major Chemicals | loss |
| LyondellBasell | US | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Major Chemicals | loss |
| Celanese | US | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Major Chemicals | loss |
| Deere | US | CYCLICAL_COMMODITY | UNCLASSIFIED | 안전(프레임 없음) | Industrial Machinery/Components | no_rule_matched |
| Ford | US | CYCLICAL_COMMODITY | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Auto Manufacturing | loss |
...
| Rivian | US | HYPERGROWTH_UNPROFITABLE | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Auto Manufacturing | loss |
| Lucid | US | HYPERGROWTH_UNPROFITABLE | TURNAROUND_LOSS | **위험(잘못된 프레임)** | Auto Manufacturing | loss |
...
3건 — 업종 코드 단독 판정(독트린 §4-3). `stdev_confirmed: false` 로 남아 WO-SUB-07 이 분리 집계한다.
...
| LG화학 | KR | 석유화학 — 스프레드 사이클 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | partial |
| 롯데케미칼 | KR | 석유화학 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | partial |
| POSCO홀딩스 | KR | 철강 — 원료·제품 가격 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| 현대제철 | KR | 철강 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| S-Oil | KR | 정유 — 정제마진 사이클 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| SK이노베이션 | KR | 정유·배터리 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | partial |
| HD한국조선해양 | KR | 조선 — 수주 사이클 | CYCLICAL_COMMODITY | CYCLICAL_COMMODITY | partial |
| 삼성중공업 | KR | 조선 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| HMM | KR | 컨테이너 해운 — 운임 사이클 | CYCLICAL_COMMODITY | CYCLICAL_COMMODITY | partial |
| 팬오션 | KR | 벌크 해운 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| 현대차 | KR | 완성차 — 수요 사이클 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| 기아 | KR | 완성차 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| 현대모비스 | KR | 자동차 부품 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| OCI홀딩스 | KR | 폴리실리콘 — 가격 사이클 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | partial |
| 풍산 | KR | 비철금속(구리) — 가격 사이클 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
| 세아베스틸지주 | KR | 특수강 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | partial |
...
| Cleveland-Cliffs | US | 철강·철광석 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | full |
| Dow | US | 석유화학 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | full |
| LyondellBasell | US | 석유화학 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | full |
| Celanese | US | 화학 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | full |
...
| Deere | US | 농기계 | CYCLICAL_COMMODITY | UNCLASSIFIED ⚠︎ | full |
| Ford | US | 완성차 | CYCLICAL_COMMODITY | TURNAROUND_LOSS ⚠︎ | full |
...
| Rivian | US | 전기차 — 매출 성장 + 대규모 적자 | HYPERGROWTH_UNPROFITABLE | TURNAROUND_LOSS ⚠︎ | full |
| Lucid | US | 전기차 — 적자 | HYPERGROWTH_UNPROFITABLE | TURNAROUND_LOSS ⚠︎ | full |
