...
①만 있는 카드가 30.4% 로 과반이 아니다. 3슬롯 구조를 기준으로 설계하되
생략 시 승격 규칙을 지킨다.
...
- 슬롯 ② 실체 **3/10 (30.0%)** · 슬롯 ③ 값의 위치 **3/10 (30.0%)**
...
- 슬롯 ② 실체 **9/362 (2.5%)** · 슬롯 ③ 값의 위치 **247/362 (68.2%)**
