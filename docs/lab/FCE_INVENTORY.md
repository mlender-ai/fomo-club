...
계산만 하지 않고 **147건에 실제로 돌려봤다**:

| | N | 승 | 패 | 승률 | PF | 순손익 |
|---|---|---|---|---|---|---|
| 3배 (실제) | 147 | 75 | 70 | 51.72% | 0.5952 | **−148.73** |
| 1배 (환산) | 147 | 75 | 70 | **51.72%** | **0.5952** | **−49.58** |

**부호가 바뀐 거래 0건.** 승률도 손익비도 소수점까지 같다.

> ⚠️ 1배 순손익 **−49.58** 은 고래 반사실의 −49.58 과 **아무 관계 없는 우연**이다.
> 여기 것은 −148.73 ÷ 3 이다. 두 수를 같은 것으로 읽지 않는다.
