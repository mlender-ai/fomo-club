...
const BANDS: readonly BandTemplate[] = [
  {
    ...
    comments: [
      (k) =>
        `오늘 다들 ${k} 얘기뿐이에요. 혼자 놓친 것 같은 기분 들기 쉬운 날이죠. ` +
        `근데 이미 한참 달아오른 걸 따라 들어가는 건 늘 조심하는 게 좋아요.`,
      (k) =>
        `${eun(k)} 오늘 제일 시끄러운 키워드예요. ` +
        `다 놓친 기분 들죠? 그래도 따라가는 건 천천히, 늦었다고 조급해 마세요.`,
    ],
    whyTitle: "오늘 왜 여기에 다들 쏠렸을까요?",
    rememberTitle: "근데 이건 기억해요",
    remembers: [
      () => "다들 좋다고 몰릴 때가 보통 제일 비쌀 때예요. 오늘 못 탔다고 아쉬워할 필요 없어요. 기회는 또 와요.",
      () => "제일 뜨거울 때 들어가면 늦는 경우가 많아요. 오늘 놓쳤어도 괜찮아요 — 기회는 또 와요.",
    ],
  },
  {
    min: 61,
    comments: [
      ...
      (k) =>
        `오늘 ${k} 쪽으로 시선이 꽤 쏠렸어요. 다들 보니까 나도 봐야 하나 싶죠? ` +
        `그 마음일수록 조심해서 천천히요.`,
    ],
    whyTitle: "오늘 왜 여기에 다들 쏠렸을까요?",
    rememberTitle: "근데 이건 기억해요",
    remembers: [
      () => "분위기로 달아오른 건 분위기로 식기도 해요. '나만 놓쳤다'는 마음이 들 때일수록 천천히요.",
      () => "다들 몰릴 때가 제일 휩쓸리기 쉬워요. 안 급해도 돼요.",
    ],
  },
  {
    min: 41,
    comments: [
      (k) =>
        `오늘은 ${k} 쪽으로 시선이 조금씩 모이는 날이에요. ` +
        `크게 들뜨진 않았어요. 급할 거 없어요.`,
      (k) =>
        `${k} 얘기가 슬슬 보이네요. 후끈하진 않고 관심 붙는 정도예요. ` +
        `천천히 봐도 돼요.`,
    ],
    whyTitle: "오늘 왜 여기에 시선이 모였을까요?",
    rememberTitle: "근데 이건 기억해요",
    remembers: [
      () => "이런 날은 섣불리 움직이기보다 지켜보는 사람이 많아요. 안 급해도 돼요.",
      () => "조용히 붙는 관심은 천천히 봐도 늦지 않아요. 급할 거 없어요.",
    ],
  },
  {
    min: 21,
    comments: [
      (k) =>
        `${eun(k)} 오늘 좀 잠잠했어요. 크게 들썩이진 않았어요. ` +
        `무서워할 것도, 급할 것도 없어요.`,
      (k) =>
        `오늘 ${k} 얘기는 조용한 편이에요. 한 박자 쉬어가는 날이죠. ` +
        `안 급해도 돼요.`,
    ],
    whyTitle: "오늘은 왜 잠잠했을까요?",
    rememberTitle: "근데 이건 기억해요",
    remembers: [
      () => "크게 올랐던 자리는 식을 때도 크게 식어요. 오를 때 못 탔다고 아쉬워하지 않아도 되는 이유예요.",
      () => "잠잠한 날은 잠잠한 대로 괜찮아요. 무서워할 것 없어요.",
    ],
  },
  {
    min: 0,
    comments: [
      (k) =>
        `${eun(k)} 오늘 거의 조용했어요. 다들 관심이 다른 데 가 있어요. ` +
        `조용한 건 나쁜 게 아니에요.`,
      (k) =>
        `오늘 ${k} 얘기는 거의 안 보였어요. 이런 날도 있는 거예요. ` +
        `안 급해도 돼요.`,
    ],
    whyTitle: "오늘은 왜 잠잠했을까요?",
    rememberTitle: "근데 이건 기억해요",
